...
function sendWhatsAppNotification() {
    const phoneNumber = "0895611127740"; // Nomor lu, tuanku!
    const message = "Pacar cantiknya dimas telah memaafkan 😍💖"; // Pesan yang dikirim
    ...
    // Log untuk debugging
    console.log("📱 Mengirim notifikasi WhatsApp ke:", phoneNumber);
    console.log("💌 Pesan:", message);
    
    // Buka WhatsApp di tab baru
    window.open(whatsappURL, '_blank');
    
    // Alternative: Kalo mau pake window.location (redirect langsung)
    // window.location.href = whatsappURL;
    
    // Tambahan efek konfirmasi
...
function showWhatsAppConfirmation() {
    ...
    confirmation.className = 'whatsapp-confirmation animate__animated animate__bounceIn';
    confirmation.innerHTML = `
        <div class="whatsapp-alert">
            <i class="fab fa-whatsapp fa-2x text-success"></i>
            <p>Notifikasi WhatsApp terkirim ke Dimas! 💌</p>
            <small>Dimas udah tahu sayangg maafin Dimas! 😍</small>
        </div>
    `;
    ...
    confirmation.style.background = 'rgba(37, 211, 102, 0.9)';
    ...
    confirmation.style.border = '2px solid #25D366';
...
// Update Event Listener untuk tombol maaf
function initEventListeners() {
    ...
    forgiveBtn.addEventListener('click', function() {
        // 1. Update button text & animation
        ...
        // 4. Create explosion of hearts
        createHeartExplosion();
        
        // 5. Play success sound (if needed)
        playSuccessSound();
        
        // 6. Change page title
        document.title = "😍 Sayangg Udah Maafin Dimas!";
        
        // 7. Tambahin efek konfirmasi extra
        setTimeout(() => {
            const extraMessage = document.createElement('div');
            extraMessage.className = 'text-center mt-3';
            extraMessage.innerHTML = `
                <p class="text-warning animate__animated animate__pulse animate__infinite">
                    <i class="fas fa-mobile-alt"></i> Notifikasi udah dikirim ke WhatsApp Dimas!
                </p>
            `;
    ...
    // Tambahkan style untuk WhatsApp alert di CSS
...
// Panggil fungsi addWhatsAppStyles saat load
document.addEventListener('DOMContentLoaded', function() {
    console.log('Website Permintaan Maaf Dimas Telah Aktif! 💖');
    console.log('🔧 WhatsApp Integration: READY');
    console.log('📱 Target Number: 0895611127740');
